...
function renderHome() {
  ...
  if (window.getRecommendedMatch && UD) {
    ...
    if (rec) topHtml += '<div onclick="window.showRecommendedMatch && showRecommendedMatch()" style="background:linear-gradient(135deg,rgba(0,255,156,.1),rgba(0,212,255,.05));border:1px solid rgba(0,255,156,.2);border-radius:12px;padding:10px 14px;margin-bottom:10px;cursor:pointer;display:flex;align-items:center;gap:10px"><span style="font-size:20px">⚡</span><div style="flex:1"><div style="font-size:12px;font-weight:700;color:var(--green)">Recommended for You</div><div style="font-size:11px;color:var(--txt2)">' + rec.name + ' · ₹' + (rec.entryFee||0) + ' entry</div></div><i class="fas fa-chevron-right" style="color:var(--txt2)"></i></div>';
    }
...
function startWd() {
  ...
  h += '<div style="font-size:13px;color:var(--txt2);margin-bottom:12px">Available: <strong style="color:var(--green)">₹' + totalBal + '</strong> (min ₹50)</div>';
...
function renderProfile() {
  ...
  else h += '<p style="color:var(--txt2);font-size:13px;text-align:center;padding:12px">No achievements yet — play more!</p>';
  h += '</div>';
  ...
  // CLEAN Quick Tools — only most useful ones
